...
async function processPayment(paymentId, env) {
  ...
  const direccionHtml = isPickup
    ? '🦩 RETIRO donde los Tíos Flamingo (coordinar lugar y horario por WhatsApp)'
    : shipping
